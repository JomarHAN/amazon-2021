...
export const PRODUCT_RECOUNT_REQUEST = 'PRODUCT_RECOUNT_REQUEST'
export const PRODUCT_RECOUNT_SUCCESS = 'PRODUCT_RECOUNT_SUCCESS'
export const PRODUCT_RECOUNT_FAIL = 'PRODUCT_RECOUNT_FAIL'
export const PRODUCT_RECOUNT_RESET = 'PRODUCT_RECOUNT_RESET'

export const PRODUCT_FIELDS_LIST = "PRODUCT_FIELDS_LIST"